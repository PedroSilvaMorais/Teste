...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal List<Cliente> PesquisaCPF(string pCPF)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", pCPF));

            DataSet ds = base.Consultar("FI_SP_PesqClienteCPF", parametros);
            List<DML.Cliente> cli = ConverterCPF(ds);
        ...
        private List<DML.Cliente> ConverterCPF(DataSet ds)
        {
            List<DML.Cliente> lista = new List<DML.Cliente>();
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
